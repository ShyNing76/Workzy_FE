...
const HNBuildingManager = () => {
    ...
    const [buildings, setBuildings] = useState([
      ...
      const [currentBuilding, setCurrentBuilding] = useState({id: "", name: "", location: "", description: "", rating: "", address: "", status: "", managerId: "", images: ""});
      ...
      const generateBuildingId = () => {
        const lastId = buildings.length > 0 ? buildings[buildings.length - 1].id : 'Bui0';
      ...
      const handleAddBuilding = (e) => {
        e.preventDefault();
        const newBuilding = { ...currentBuilding, id: generateBuildingId(), status: "Active"};
      ...
      const handleUpdateBuilding = (e) => {
        ...
        setBuildings((prevBuildings) => {
          const buildingIndex = prevBuildings.findIndex((building) => building.id === currentBuilding.oldId);
          if (buildingIndex !== -1) {
        ...
        setCurrentBuilding({id: '', name: '', location: '', description: '', rating: '', address: '', status: '', managerId: '', images: ''});
      };
    ...
    return(
        ...
        <table className="table table-zebra w-full">
          ...
          <tbody>
            ...
            <tr>
              <td colSpan="4" className="text-center">No buildings found.</td>
            </tr>
          )}
          </tbody>
        </table>
