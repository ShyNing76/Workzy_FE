...
const BookingsManagerPage = () => {
    ...
    const [bookings, setBookings] = useState(
        { id: "BK01", customerID: "MB01", totalAmenitiesPrice: "100000", totalWorkspacePrice: "200000", totalBrokenPrice: "0", totalPrice: "300000", startTimeDate: "", endTimeDate: "", workspaceID: "WS01" },
        { id: "BK02", customerID: "MB02", totalAmenitiesPrice: "200000", totalWorkspacePrice: "300000", totalBrokenPrice: "400000", totalPrice: "900000", startTimeDate: "", endTimeDate: "", workspaceID: "WS02" },
        { id: "BK03", customerID: "V01", totalAmenitiesPrice: "300000", totalWorkspacePrice: "400000", totalBrokenPrice: "0", totalPrice: "700000", startTimeDate: "", endTimeDate: "", workspaceID: "WS03" }
    )
    ...
    const [currentBooking, setCurrentBooking] = useState({ id: "", customerID: "", totalAmenitiesPrice: "", totalWorkspacePrice: "", totalBrokenPrice: "", totalPrice: "", startTimeDate: "", endTimeDate: "", workspaceID: ""});
    const [bookingToDelete, setBookingToDelete] = useState(null);
    const [successMessage, setSuccessMessage] = useState("");

    const addBookingFields = [
        { label: "Customer ID", name: "customerID", type: "text" },
        { label: "Total Amenities Price", name: "totalAmenitiesPrice", type: "number" },
        { label: "Total Workspace Price", name: "totalWorkspacePrice", type: "number" },
    ...
    const generateBookingId = () => {
        const lastId = bookings.length > 0 ? bookings[bookings.length - 1].id : "BK00";
        const newId = `BK${(parseInt(lastId.substring(2)) + 1).toString().padStart(2, '0')}`;
        return newId;
    }
    ...
    const handleAddBookingSubmit = (e) => {
        ...
        setCurrentBooking({ id: '', customerID: '', totalAmenitiesPrice: '', totalWorkspacePrice: '', totalBrokenPrice: '', totalPrice: '', startTimeDate: '', endTimeDate: '', workspaceID: '' })
    }

    const handleUpdateBookingSubmit = (e) => {
        e.preventDefault();
        setBookings((prevBookings) => {
            const bookingIndex = prevBookings.findIndex((booking) => booking.id === currentBooking.id);
            if (bookingIndex !== -1) {
    ...
    return (
        <div className="container mx-auto px-4 sm:px-8">
            ...
            <div className="grid grid-cols-2">
                ...
                {/* Add Button */}
            <div className="ml-2">
                <AddButton onClick={() => setShowAddModal(true)} label="Add Booking" />
            </div>
