...
import BuildingFilter from "../../../../components/layout/Admin/Filters/BuildingFilter.jsx";

const HNWorkspacesManager = () => {
  ...
  const handleUpdateWorkspace = (e) => {
    ...
    setWorkspaces((prevWorkspaces) => {
      const workspaceIndex = prevWorkspaces.findIndex(
        (workspace) => workspace.id === currentWorkspace.oldId
      );
      if (workspaceIndex !== -1) {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-4xl font-black mb-4">Ha Noi Workspace List</h1>
      ...
      <div className="overflow-x-auto flex flex-1 mb-2">
        <div className="mt-1 flex">
          <CiFilter className="mr-2 size-6" />
...
export default HNWorkspacesManager;
