  ...
  return (
    <>
      <div className="room-list-container">
        <div className="room-list-page-1 mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:px-6 sm:py-10 lg:max-w-7xl lg:grid-cols-4 lg:px-8 item-center">
