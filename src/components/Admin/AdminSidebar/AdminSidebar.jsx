            ...
            {/* Sidebar content here --------------------------------------------------------------------*/}
                ...
                <li className="mb-1">
                    <Link to="/admin" className={`tab ${location.pathname === '/admin' ? 'active' : ''}`}>
                        <div className="flex flex-1"><RxDashboard className="text-2xl" /><p className="ml-2">Dashboard</p></div>
                    </Link>
                </li>

                <li className="mb-1">
                    <Link to="/admin/servicesmanager" className={`tab ${location.pathname === '/admin/servicesmanager' ? 'active' : ''}`}>
                        <div className="flex flex-1"><PiCube className="text-2xl"/> <p className="ml-2">Manage Services</p> </div>
                    </Link>
                </li>
                ...
                <li className="mb-1">
                    <Link to="/admin/managersmanager" className={`tab ${location.pathname === '/admin/managersmanager' ? 'active' : ''}`}>
                        <div className="flex flex-1"><PiIdentificationBadge className="text-2xl"/><p className="ml-2">Manage Manager</p></div>
                    </Link>
                </li>

                <li className="mb-1">
                    <Link to="/admin/staffsmanager" className={`tab ${location.pathname === '/admin/staffsmanager' ? 'active' : ''}`}>
                        <div className="flex flex-1"><GoPerson className="text-2xl"/><p className="ml-2">Manage Staffs</p></div>
                    </Link>
                </li>

                <li className="mb-1">
                    <details open>
                        <summary><GoPeople className="text-2xl"/> &nbsp; Manage Customer</summary>
                        <ul>
                            <li className="mb-1">
                                <Link to="/admin/membersmanager" className={`tab ${location.pathname === '/admin/membersmanager' ? 'active' : ''}`}>
                                    <div className="flex flex-1"><IoAccessibilityOutline className="text-2xl"/><p className="ml-2">Members</p></div>
                                </Link>
                            </li>
                            <li className="mb-1">
                                <Link to="/admin/vipsmanager" className={`tab ${location.pathname === '/admin/vipsmanager' ? 'active' : ''}`}>
                                    <div className="flex flex-1"><IoDiamondOutline className="text-2xl"/><p className="ml-2">VIPs</p></div>
                                </Link>
                            </li>
                        </ul>
                    </details>
